    ...
    <View style={styles.container}>
      ...
      <ScrollView>
        <View style={styles.gallery}>
          <Image
            source={require('./assets/Fitur_Ormawa.png')}
        ...
        <View style={styles.card}>
          <Image
            source={require('./assets/Gerakan Mahasiswa.png')}
        ...
        <View style={styles.card}>
          <Image
            source={require('./assets/Group 162975.png')}
            style={styles.cardImage}
          />
          <View style={styles.cardText}>
      ...
      <View style={styles.footer}>
        ...
        <View style={styles.footerItem}>
          ...
          <Text style={[styles.footerText, { color: 'orange' }]}>Kategori</Text>
        </View>
        <View style={styles.footerItem}>
