          ...
          >
            ...
            >
              <Text style={{ color: "#222222", fontSize: 18, width: 332 }}>
                {"Apakah boleh seorang mahasiswa tidak\nmengikuti organisasi mahasiswa?"}
              </Text>
            </View>
            ...
            >
              <Text style={{ color: "#222222", fontSize: 12, width: 318 }}>
                {"Ya, keikutsertaan dalam organisasi mahasiswa adalah\npilihan.\n\nTidak ada kewajiban bagi seorang mahasiswa untuk\nmenjadi anggota organisasi mahasiswa.\n\nNamun demikian, mengikuti organisasi dapat memberikan\nbanyak manfaat tambahan selama masa kuliah. "}
              </Text>
            </View>
          </View>
