  ...
  return (
    <SafeAreaView style={isDarkMode ? styles.darkContainer : styles.lightContainer}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Informasi Fakultas</Text>
      </View>
        ...
        >
          <View style={styles.modalContainer}>
            <View style={styles.modalContent}>
              ...
              <Text style={styles.modalText}>Tanggal Pendaftaran: {selectedInfo.dates}</Text>
              <Text style={styles.modalText}>Narahubung: {selectedInfo.contact}</Text>
              <Text
