        ...
        <View style={styles.column}>
          ...
          <View style={styles.column3}>
            <View style={styles.row3}>
			    <Image
			    source={require('C:/Users/User/Zann/PROFIL_SINGKAT_ORMAWA/ASET_LOGO_ORMAWA/LOGO_ORMAWA_FAKULTAS/FK.png')}
			    style={{ borderRadius: 14, width: 76, height: 76, }}
			    />
              <View style={styles.column4}>
                <Text style={styles.text2}>{"BEM FK "}</Text>
                <Text style={styles.text3}>{"Badan Eksekutif Mahasiswa Fakultas Kedokteran "}</Text>
              </View>
            </View>
