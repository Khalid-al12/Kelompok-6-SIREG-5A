          ...
          >
            ...
            >
              <Text style={{ color: "#222222", fontSize: 18, width: 332 }}>
                {"Apakah organisasi mahasiswa dapat\nmengganggu kegiatan belajar?"}
              </Text>
            </View>
            ...
            >
              <Text style={{ color: "#222222", fontSize: 12, width: 318 }}>
                {"Secara umum, keikutsertaan dalam organisasi mahasiswa\ntidak seharusnya mengganggu kegiatan belajar jika diatur\ndengan baik.\n\nNamun, jika seseorang tidak dapat mengelola waktu\ndengan efektif antara kegiatan organisasi dan akademik,\nkemungkinan akan terjadi gangguan.\n\nPenting bagi mahasiswa untuk memiliki keseimbangan\nantara kegiatan organisasi dan akademik agar tidak\nmengorbankan kualitas pendidikan mereka. "}
              </Text>
            </View>
          </View>
