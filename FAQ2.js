          ...
          >
            ...
            >
              <Text style={{ color: "#222222", fontSize: 18, width: 332 }}>
                {"Apa perbedaan organisasi mahasiswa\ntingkat universitas dan tingkat\nfakultas?"}
              </Text>
            </View>
            ...
            >
              <Text style={{ color: "#222222", fontSize: 12, width: 318 }}>
                {"Perbedaan utama antara organisasi mahasiswa tingkat\nuniversitas dan tingkat fakultas terletak pada cakupan dan\nlingkup kerjanya.\n\nOrganisasi mahasiswa tingkat universitas lebih bersifat\nmenyeluruh dan mewakili seluruh mahasiswa di universitas,\nsementara organisasi mahasiswa tingkat fakultas lebih\nterfokus pada mahasiswa yang terdaftar di fakultas\ntertentu.\n\nSelain itu, agenda dan program kerja kedua jenis\norganisasi ini juga bisa berbeda sesuai dengan kebutuhan\ndan karakteristik mahasiswa di tingkat universitas atau\nfakultas. "}
              </Text>
            </View>
          </View>
